...
{
  int8_t sum=0;
  int8_t data1_low,data1_high,data2_low,data2_high,data3_low,data3_high,data4_low,data4_high;
  data1_low=0xFF & data1;
  data1_high=data1>>8;
  data2_low=0xFF & data2;
  data2_high=data2>>8;
  data3_low=0xFF & data3;
  data3_high=data3>>8;
  data4_low=0xFF & data4;
  data4_high=data4>>8;
  sum+=data1_low;
  sum+=data1_high;
  sum+=data2_low;
  ...
  sum+=data4_low;
  sum+=data4_high;
  Uart_SendChar(UARTR1,data1_low);
  Uart_SendChar(UARTR1,data1_high);
  Uart_SendChar(UARTR1,data2_low);
  Uart_SendChar(UARTR1,data2_high);
  Uart_SendChar(UARTR1,data3_low);
  Uart_SendChar(UARTR1,data3_high);
  Uart_SendChar(UARTR1,data4_low);
  Uart_SendChar(UARTR1,data4_high);
  Uart_SendChar(UARTR1,sum);
}
