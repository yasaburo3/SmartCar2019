 ...
 *
 * @file      i2c.c
 * @brief         provide APIs for configuring I2C module
 * @author    Freescale
 * @date      2018-04-06
 *
 ********************************************************************************/
 ...
 *            pI2CConfig point to I2C configure structure
 * @return    none
 ************************************************************/
...
/************************************************************
 * @brief     SCL low timeout value that determines the timeout period of SCL
 *low
 * @param     pI2Cx point to I2C module type
 *            u16Timeout
 * @return    none
 ...
 * @param     pI2Cx point to I2C module type
 *            u8WrBuff data buffer for writing
 * @return    error status
 ************************************************************/
 ...
 * @param     pI2Cx point to I2C module type
 *            pRdBuff point to the data read from slave I2C
 *            u8Ack send out ack or nack
 * @return    error status
 ************************************************************/
 ...
 * @param     pI2Cx point to I2C module type
 *            u16SlaveAddress slave address
 *            pWrBuff point the first address of transferring data buffer
 *            u32Length the length of transferring data
 * @return    error status
 ************************************************************/
uint8_t I2C_MasterSendWait(I2C_Type* pI2Cx, uint16_t u16SlaveAddress,
  ...
  /* if no error occur, received the correct ack from slave continue to send
   * data to slave */
 ...
 * @param     pI2Cx point to I2C module type
 *            u16SlaveAddress slave address
 *            pRdBuff point the first address of reading data buffer
 *            u32Length the length of transferring data
 * @return    error status
 ************************************************************/
 ...
 * @param     pCallBack point to address of I2C1 call back function
 * @return    none
 ************************************************************/
 ...
 * @param     pCallBack point to address of I2C0 call back function
 * @return    none
 ************************************************************/
