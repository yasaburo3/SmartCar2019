...
for axample         FTM_count_init(CFTM0);       
*************************************************************************/
uint16_t FTM_count_get(FTMn_e ftm)
{
  //return FTMx[ftm]->CNT ;
	return FTMx[ftm]->CONTROLS[0].CnV;
}
...
//  PIT_Init(PIT_CHANNEL1,100);//定时500MS
//  while(1)
//  {    
//    
//  }
