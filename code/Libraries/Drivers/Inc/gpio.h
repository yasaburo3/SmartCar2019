 ...
 ************************************************************/
#define CONFIG_PIN_AS_GPIO(port, port_pin, mode) \
  XCONFIG_PIN_AS_GPIO(port, port_pin, mode)
#define XCONFIG_PIN_AS_GPIO(port, port_pin, mode) \
  (mode == 0) ? (port->PDDR &= ~(1 << port_pin))  \
